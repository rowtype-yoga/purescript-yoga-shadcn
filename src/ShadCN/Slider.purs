...
slider props = createElement Radix.sliderRoot (mergeProps { className: "relative flex w-full touch-none items-center select-none data-[disabled]:opacity-50" } props)
